...
| 线程 | 问题 | 提出于 | 状态 |
|---|---|---|---|
| T-0014 | v0.9.4 只读表漏判、exact/parent evidence 规则与部署决策 | 2026-09-15 | final 已获用户审核通过并授权 Git 发布；exact/parent 规则保持，定向简化延期。本轮不安装本地插件，Codex 接入不在范围 |
| T-0015 | 历史增长及定向简化方案 | 2026-09-15 | 待审提案见 claims/C-20260915-02.md；未执行架构重写或删代码 |
